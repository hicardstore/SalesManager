            ...
            {mode !== "reset" && (
              <>
                <div className="relative flex items-center py-2">
                  ...
                  <span className="flex-shrink-0 mx-4 text-neutral-400 text-[10px] font-bold uppercase tracking-wider">
                    أو
                  </span>
                  <div className="flex-grow border-t border-neutral-200"></div>
                </div>
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full bg-white hover:bg-neutral-50 text-neutral-800 border border-neutral-200 rounded-xl py-3 font-bold text-xs transition-colors shadow-sm disabled:opacity-75 cursor-pointer flex items-center justify-center gap-2"
                >
